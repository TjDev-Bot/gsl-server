<?php
namespace App\Controllers\WMS\NJ\Locations\18Muller;
...
class Inventory extends BaseController
{
    public function __construct() {
        ...
        $this->builder = $this->db->table('18muller_inventory');
    }
    ...
    public function index() {
        ...
        $data = [
            'title'   => '18Muller Inventory',
            'route'   => 'wms/nj/18muller/inventory',
        ];
        return view('wms/nj/18muller/inventory/index', $data);
