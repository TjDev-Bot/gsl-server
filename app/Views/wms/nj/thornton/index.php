...
<div class="container">
				<div class="row dashboard d-flex text-center p-5 ">
				    <a class="col dashboard-card" href="/wms/nj/delivery">
...
<h2>DELIVERY SCHEDULER</h2>
			...
			<a class="col dashboard-card" href="/wms/nj/thornton/receiving">
...
<a class="col dashboard-card" href="/wms/nj/thornton/inventory">
